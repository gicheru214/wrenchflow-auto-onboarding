...
//
// Numbers are rightsized for the typical independent shop doing
// <$10K/mo profit (~$30K–$80K/mo revenue). Each revBump is the
// realistic max recoverable revenue for the worst-pain answer on
// that question. The bumpFor() formula scales between 35%–100% of
// revBump based on which option the user picks, so a typical user
// lands ~$40–$80K/yr in displayed recoverable revenue — meaningful
// but not absurd for a shop their size.
...
export const QUESTIONS: Question[] = [
  {
    ...
    hit: "Each lost regular is worth <strong>$1,400–$2,800/yr</strong> in repair + maintenance LTV. Even a small shop is quietly bleeding <strong>$3K–$6K/yr</strong> in silent churn.",
  ...
  },
  {
    ...
    hit: "Recovering even <strong>1 in 4</strong> with a 7-day cancel-save flow is worth <strong>$2K–$4K/yr</strong> on a shop your size.",
  ...
  },
  {
    ...
    avg: "The average independent shop loses 8–14 hrs/week to manual estimate-and-followup loops. That's an extra wrenching day, gone.",
    hit: "At your door rate, those hours = <strong>$6K–$10K/yr</strong> in unbillable admin time you're subsidizing yourself.",
  ...
  },
  {
    ...
    avg: "Most independent shops run at 58–72% bay utilization. The top quartile runs 84–91% — same techs, same square footage.",
    hit: "Tightening even one bay-hour/day at $115 effective labor = <strong>$8K–$12K/yr</strong> in pure capacity left on the table.",
  ...
  },
  {
    ...
    hit: "Missing 2 due-services per week × $295 average ticket = <strong>$10K–$14K/yr</strong> walking to the chain shop down the road.",
  ...
  },
  {
    ...
    hit: "One missed tow-eligible job = <strong>$650–$1,400</strong>. Two missed/month = <strong>$10K–$15K/yr</strong> in unanswered intent.",
  ...
  },
  {
    ...
    hit: "Lifting close rate from 45% → 60% on a typical book your size adds <strong>$8K–$10K/yr</strong> with zero new leads.",
  ...
  },
  {
    ...
    hit: "Each happy referral = <strong>$1,800 LTV</strong>. Trust friction quietly costs <strong>$2K–$5K/yr</strong> in word-of-mouth you're not getting.",
  ...
  },
  {
    ...
    text: "If every bay turned 1 more car/day with no extra labor or hours, how much extra monthly revenue would that mean?",
    opts: [
      "Under $2K/mo",
      "$2K–$4K/mo",
      "$4K–$7K/mo",
    ...
    avg: "1 extra car × $295 ticket × 22 days × 2 bays = <strong>~$13K/mo</strong> in pure throughput unlock at a typical 2-bay independent.",
    hit: "Auto-equipped shops hit a <strong>10–18%</strong> bay-throughput lift in the first 60 days. No new techs. No new building.",
  ...
  },
  {
    ...
    hit: "Shops that import 90 days of RO history on day one see <strong>$2K–$4K of recovered revenue</strong> in the first 30 days alone.",
  ...
  // ---------- New S/A-tier battery ----------
  {
    ...
    hit: "At 12 jobs/week × 2.7 calls × 9 min = <strong>5+ hrs/week</strong> on the phone — and ~$2.5K/yr of cold bays waiting on parts ETA.",
  ...
  },
  {
    ...
    hit: "Without per-RO margin, you're re-quoting your worst jobs and under-pricing your best. The hidden cost: <strong>$4K–$7K/yr</strong> in mispriced repeat work.",
  ...
  },
  {
    ...
    hit: "A 0.5-hour/day swing per tech × 2 techs × $115 effective = <strong>$5K–$8K/yr</strong> in invisible labor leakage.",
  ...
  },
  {
    ...
    avg: 'The median independent shop carries $8K–$18K in AR — fleet, warranty, and "I\'ll pay you Friday" tickets. ~40% of owners can\'t answer this within $5K.',
    hit: "Every $1 in AR over 30 days has a ~12% chance of never being collected. Aged AR = <strong>$2K–$5K/yr</strong> in silent write-offs at your size.",
  ...
  },
  {
    ...
    avg: "A loaded bay-hour (rent, utilities, tech burden, equipment amortization) costs $74–$96 to operate. The average independent shop sells it at $115 — leaving 18–28% on the table.",
    hit: "Underpricing your bay-hour by even $10 across 24 billable hrs/wk × 50 wks = <strong>$4K–$5K/yr per bay</strong> you're donating to your customers.",
  ...
  },
  {
    ...
    hit: "Lifting same-day DVI close from 3 → 5 on a book your size = <strong>$7K–$9K/yr</strong> in already-diagnosed work that wasn't walking out the door.",
  ...
  },
  {
    ...
    hit: "Each chronic-slip customer churns at 2.1× the normal rate. Promise-miss churn quietly costs <strong>$2.5K–$4K/yr</strong> in LTV.",
  ...
  },
  {
    ...
    hit: "Switching the default channel from phone to photo-text on extra-work upsells lifts approval ~26 points — <strong>$3K–$5K/yr</strong> in already-found work at your size.",
